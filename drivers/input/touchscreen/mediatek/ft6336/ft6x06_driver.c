...
/// wanglj, DATE20150804, NOTE, Bug FADALTHA-127 START {
...
static  int update_firmware_thread(void *priv)
{
    ...
    CTP_DBG("[WLJ]update_firmware_thread, g_tpdrv_update_state =%d \n",g_tpdrv_update_state);
#endif  /* CONFIG_PROJECT_WIKO_UNIFY */
    /// wanglj, Bug FADALTHA-127 END }
...
#if defined (FTS_AUTO_TP_UPGRADE) /*&& !defined (CONFIG_PROJECT_WIKO_UNIFY)*/
...
#endif//CONFIG_TOUCHSCREEN_POWER_DOWN_WHEN_SLEEP
#if 1//Android 4.0 don't need to report these up events.
...
void ft6x06_tpd_get_fw_version( char * fw_vendor_numb )
{
  ...
  //  GTP_INFO("ft6x06_tpd_get_fw_version: version_info =  %d",version_info);  
//    return version_info;
}
