...
void GC0310_Sensor_Init(void)
{
	...
	GC0310_write_cmos_sensor(0x01,0x03);             
    GC0310_write_cmos_sensor(0x02,0x11);
    ...
    GC0310_write_cmos_sensor(0x45,0xa0);
    ...
    GC0310_write_cmos_sensor(0x79,0x5f); 
        ...
        ///////////////////   DNDD  /////////////////////
        ///////////////////////////////////////////////// 
    GC0310_write_cmos_sensor(0x82,0x14); //08
    GC0310_write_cmos_sensor(0x83,0x0b);
        ...
        //////////////////   EEINTP  ////////////////////
        ///////////////////////////////////////////////// 
    GC0310_write_cmos_sensor(0x8f,0x44); 
    ...
    GC0310_write_cmos_sensor(0x95,0x62); 
    ...
    GC0310_write_cmos_sensor(0xcf,0xff);
        ...
        /////////////////////////////////////////////////
    GC0310_write_cmos_sensor(0xd0,0x40); 
    GC0310_write_cmos_sensor(0xd1,0x28); //30
    GC0310_write_cmos_sensor(0xd2,0x28); //30
    GC0310_write_cmos_sensor(0xd3,0x44); 
    ...
    GC0310_write_cmos_sensor(0x0c,0x20); //00
    GC0310_write_cmos_sensor(0x12,0x52);
    GC0310_write_cmos_sensor(0x13,0x40); //38
...
//////////////AWB/////////
    ...
    GC0310_write_cmos_sensor(0x21,0x14); 
    ...
    GC0310_write_cmos_sensor(0x6e,0x20);
    ...
    GC0310_write_cmos_sensor(0x7c,0x0c);//0c
    ...
    GC0310_write_cmos_sensor(0x92,0xea);
    GC0310_write_cmos_sensor(0x93,0xd0);
    GC0310_write_cmos_sensor(0x95,0x14);
    GC0310_write_cmos_sensor(0x96,0xea);
    GC0310_write_cmos_sensor(0x97,0x51);
    GC0310_write_cmos_sensor(0x98,0x15);
    GC0310_write_cmos_sensor(0x9a,0x52);
    GC0310_write_cmos_sensor(0x9b,0x15);
        
    GC0310_write_cmos_sensor(0x9c,0x88);
    GC0310_write_cmos_sensor(0x9d,0x52);
    GC0310_write_cmos_sensor(0x9f,0xa2);
    ...
    GC0310_write_cmos_sensor(0xa6,0xc4);
    GC0310_write_cmos_sensor(0xa7,0x8f);
    GC0310_write_cmos_sensor(0xa9,0xc4);
    GC0310_write_cmos_sensor(0xaa,0x8f);
    GC0310_write_cmos_sensor(0xab,0xa2);
    GC0310_write_cmos_sensor(0xac,0x80);
    GC0310_write_cmos_sensor(0xae,0xc4);
    GC0310_write_cmos_sensor(0xaf,0xa3);
    GC0310_write_cmos_sensor(0xb0,0xcf);
    GC0310_write_cmos_sensor(0xb1,0x96);
    GC0310_write_cmos_sensor(0xb3,0xc5);
    GC0310_write_cmos_sensor(0xb4,0x9c);
    ...
    GC0310_write_cmos_sensor(0xb8,0xdb);
    GC0310_write_cmos_sensor(0xb9,0x84);
        
        /////////////////////////////////////
        ////////////////////  CC ////////////
        /////////////////////////////////////
    GC0310_write_cmos_sensor(0xfe,0x01);
    GC0310_write_cmos_sensor(0xd0,0x34);
    GC0310_write_cmos_sensor(0xd1,0xfd);
    GC0310_write_cmos_sensor(0xd2,0x06);//0a
    GC0310_write_cmos_sensor(0xd3,0xf0);
    GC0310_write_cmos_sensor(0xd4,0x40);
    GC0310_write_cmos_sensor(0xd5,0x08);//f0
    ...
    GC0310_write_cmos_sensor(0xc4,0x48);
    GC0310_write_cmos_sensor(0xc5,0x30); 
    GC0310_write_cmos_sensor(0xc6,0x30); 
    GC0310_write_cmos_sensor(0xc7,0x70);
    GC0310_write_cmos_sensor(0xc8,0x50);
    GC0310_write_cmos_sensor(0xc9,0x50);
...
BOOL GC0310_set_param_banding(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0310_write_cmos_sensor(0x27, 0x02);   //exp level 0  14.28fps
			...
			GC0310_write_cmos_sensor(0x2d, 0x08);   //exp level 3  5.55fps
...
BOOL GC0310_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:	
			GC0310_write_cmos_sensor(0xfe, 0x01);
			GC0310_write_cmos_sensor(0x13, 0x40);//35
			GC0310_write_cmos_sensor(0xfe, 0x00);
		break;
